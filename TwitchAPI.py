...
def checkUser(username: str, oauth: str):  # Checks to see if someone is live
...
def getUserID(username: str,oauth: str):  # Gets the USERSID based on the Username they are given and also uses the OAUTH token
    # generated above
    HEADERS = {'client-id': CLIENT_ID, 'Authorization': 'Bearer ' + oauth}
...
def getstream(username: str, oauth: str):
